...
class Chess
  ...
  def initialize
    ...
    # Use this line for Player v.s. Computer (white first).
    # @players = { :B => Player.new(:B), :W => ComputerPlayer.new(:W) }

    # User this line for Player v.s. Player.
    # @players = { :B => Player.new(:B), :W => Player.new(:W) }
  end
